...
public class SwaggerConfig {
    ...
    private static final String BASE_PACKAGE = "controller";
    private static final String API_TITULO = "Brasileirao API - Scraping";
    private static final String API_DESCRICAO = "API REST que obtem dados de partidas";
    private static final String API_VERSAO = "1.0.0";
    private static final String CONTATO_NOME = "Bruno Agiani";
    private static final String CONTATO_GITHUB = "https://github.com/BrunoAgiani";
